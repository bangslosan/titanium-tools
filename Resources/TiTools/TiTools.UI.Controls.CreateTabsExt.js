/**
	...
	@events
	@methods
		addContent: // добавляет объект к табу
		(
			index: int // номер таба к которому обращаемся
			res: object // обьект который ложем во вьюшку таба
		)
...
function createTabsExt(params)
{
	...
	content.addContent = function(index,res)
	{
		masTab[index].content.add(res);
	}
